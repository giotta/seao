...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Avis.orgamisme'
        db.delete_column(u'api_avis', 'orgamisme')

        # Adding field 'Avis.organisme'
        db.add_column(u'api_avis', 'organisme',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Avis.orgamisme'
        db.add_column(u'api_avis', 'orgamisme',
                      self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Avis.organisme'
        db.delete_column(u'api_avis', 'organisme')
    ...
    models = {
        u'api.avis': {
            ...
            'organisme': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),

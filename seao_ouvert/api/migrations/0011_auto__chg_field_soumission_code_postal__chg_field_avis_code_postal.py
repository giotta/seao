...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'api_soumission', 'code_postal', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Avis.code_postal'
        db.alter_column(u'api_avis', 'code_postal', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
    ...
    models = {
        u'api.avis': {
            ...
            'code_postal': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
